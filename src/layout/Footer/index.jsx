    ...
    <footer>
      <div class="px-11 py-3 flex flex-col items-start bg-sky-900 w-screen">
        <div class="flex flex-row items-center gap-2 text-white text-md">
          <div class="stroke-white bg-[url('/Users/gabrielgonzales/Documents/sparkle-cleaners/sparklecleanersnyc/src/assets/Logo.svg')] bg-cover bg-no-repeat h-8 w-5"></div>
          <h2 class="text-sm font-Poppins">Sparkle Cleaners nyc</h2>
        </div>
